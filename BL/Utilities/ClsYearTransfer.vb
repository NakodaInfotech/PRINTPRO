...
#Region "ITEM"
    ...
    Public Function TRANSFERPAPERMATERIAL() As Integer
        Dim intResult As Integer
        Try

            Dim strCommand As String = "SP_UTILITIES_TRANSFERPAPERMATERIAL"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function TRANSFERPAPERMILL() As Integer
        Dim intResult As Integer
        Try

            Dim strCommand As String = "SP_UTILITIES_TRANSFERPAPERMILL"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function TRANSFERSIZE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_UTILITIES_TRANSFERPAPERSIZE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function TRANSFERGSM() As Integer
        Dim intResult As Integer
        Try

            Dim strCommand As String = "SP_UTILITIES_TRANSFERPAPERGSM"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function TRANSFERGRAIN() As Integer
        Dim intResult As Integer
        Try

            Dim strCommand As String = "SP_UTILITIES_TRANSFERGRAIN"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function TRANSFERCOORDINATOR() As Integer
        Dim intResult As Integer
        Try

            Dim strCommand As String = "SP_UTILITIES_TRANSFERCOORDINATOR"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function TRANSFERTAPE() As Integer
        Dim intResult As Integer
        Try

            Dim strCommand As String = "SP_UTILITIES_TRANSFERTEARTAPE"
            Dim alParameter As New ArrayList
            With alParameter
...
#Region "OTHERS"
    ...
    Public Function TRANSFERPROBLEM() As Integer
        Dim intResult As Integer
        Try

            Dim strCommand As String = "SP_UTILITIES_TRANSFERPROBLEM"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function TRANSFERSHELF() As Integer
        Dim intResult As Integer
        Try
            'save NONPURCHASE 
            Dim strCommand As String = "SP_UTILITIES_TRANSFERSHELF"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function TRANSFERNONINVITEM() As Integer
        Dim intResult As Integer
        Try

            Dim strCommand As String = "SP_UTILITIES_TRANSFERNONINVITEM"
            Dim alParameter As New ArrayList
            With alParameter
