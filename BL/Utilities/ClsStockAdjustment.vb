...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            ...
            With alParameter
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@INITEMCODE", alParaval(I)))
                I = I + 1
    ...
    Public Function SELECTSTOCKADJUSTMENT(ByVal RECONO As Integer, ByVal Cmpid As Integer, ByVal YearID As Integer) As DataTable
        Dim dtTable As DataTable
        Try
