...
#Region "Functions"
    Public Function SAVE() As DataTable
        ...
        Try
            'save  LABELING
            Dim strCommand As String = "SP_TRANS_JOBOUT_SAVE"
            ...
            With alParameter
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@JOSIZE", alParaval(I)))
                I = I + 1
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@GQTY", alParaval(I)))
                I = I + 1
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            'Update SALE order
            Dim strCommand As String = "SP_TRANS_JOBOUT_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SELECTJOBOUT(ByVal TEMPJONO As Integer, ByVal Cmpid As Integer, ByVal YearID As Integer) As DataTable
        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_SELECTJOBOUT_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SELECTPENDINGWORK(ByVal TEMPJONO As Integer, ByVal Cmpid As Integer, ByVal YearID As Integer) As DataTable
        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_SELECTPENDINGWORK_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@JONO", TEMPJONO))
                .Add(New SqlClient.SqlParameter("@CmpID", Cmpid))
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_JOBOUT_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
