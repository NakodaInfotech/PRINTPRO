...
#Region "Functions"
    Public Function SAVE() As DataTable
        ...
        Try
            'save  SCHEDULING
            Dim strCommand As String = "SP_TRANS_SCHEDULING_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            'Update SALE order
            Dim strCommand As String = "SP_TRANS_SCHEDULING_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SELECTSCHEDULING(ByVal TEMPSCHNO As Integer, ByVal Cmpid As Integer, ByVal YearID As Integer) As DataTable
        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_SELECTSCHEDULING_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_SCHEDULING_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
