...
#Region "Functions"
    Public Function SAVE() As DataTable
        ...
        Try
            'save  PUNCHING
            Dim strCommand As String = "SP_TRANS_PUNCHING_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                Dim I As Integer = 0
                .Add(New SqlClient.SqlParameter("@PNCHNO", alParaval(I)))
                I = I + 1
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@PUNCHINGDATE", alParaval(I)))
                I = I + 1
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@GSMDONE", alParaval(I)))
                I = I + 1
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            'Update SALE order
            Dim strCommand As String = "SP_TRANS_PUNCHING_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@TEMPPUNCHNO", alParaval(I)))
                I = I + 1
    ...
    Public Function SELECTPUNCHING(ByVal TEMPPUNCHNO As Integer, ByVal Cmpid As Integer, ByVal YearID As Integer) As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_SELECTPUNCHING_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_PUNCHING_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
