...
#End Region
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            Dim strcommand As String = "SP_MFG_CONSUMPTION_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            Dim strcommand As String = "SP_MFG_CONSUMPTION_UPDATE"
            Dim alparameter As New ArrayList
            With alparameter
                Dim I As Integer
    ...
    Public Function selectconsume() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_SELECTCONSUME_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_MFG_CONSUMPTION_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@consumeNO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@Cmpid", alParaval(1)))
