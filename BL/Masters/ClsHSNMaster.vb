    ...
    Public Function SAVE() As Integer
        ...
        Try
            ...
            With alParameter
                ...
                I += 1
                 .Add(New SqlClient.SqlParameter("@HSNEXPCGST", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@HSNEXPSGST", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@HSNEXPIGST", alParaval(I)))
                I += 1
