...
#End Region
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_MASTER_OPERATORMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@OPERATOR", alParaval(0)))
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save NARRATIONMaster
            Dim strCommand As String = "SP_MASTER_OPERATORMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("@OPERATORID", alParaval(7)))
