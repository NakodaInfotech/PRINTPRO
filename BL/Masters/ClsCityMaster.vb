...
#Region "Functions"
    ...
    Public Function SAVEPER() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_MASTER_PERMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                Dim I As Integer = 0
                .Add(New SqlClient.SqlParameter("@PER_AMT", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@PER_remark", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@PER_cmpid", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@PER_locationid", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@PER_userid", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@PER_yearid", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@PER_transfer", alParaval(I)))
                I += 1
    ...
    Public Function SAVEUNIT() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_MASTER_UNITMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                Dim I As Integer = 0
                .Add(New SqlClient.SqlParameter("@UNIT_ID", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@UNIT_NAME", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@UNIT_ABBR", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@UNIT_REMARKS", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@UNIT_cmpid", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@UNIT_locationid", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@UNIT_userid", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@UNIT_yearid", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@UNIT_transfer", alParaval(I)))
                I += 1
