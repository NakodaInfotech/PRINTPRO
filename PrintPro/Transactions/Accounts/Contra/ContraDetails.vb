...
Public Class ContraDetails
    ...
    Sub fillgrid(ByVal tempcondition)
        Try
            ...
            Dim dt As DataTable = objclsCMST.search(" dbo.CONTRA.CONTRA_no AS [Sr. No], dbo.Ledgers.acc_cmpname AS [Party Name] ,dbo.CONTRA.CONTRA_date AS [Date], sum(dbo.Contra.contra_credit) as Amount, ISNULL(CONTRA.CONTRA_CHQNO,'') AS CHQNO, dbo.Contra.contra_remarks AS [Remarks] ", "", "  dbo.CONTRA LEFT OUTER JOIN dbo.Ledgers ON dbo.CONTRA.CONTRA_cmpid = dbo.Ledgers.acc_cmpid AND dbo.CONTRA.CONTRA_LOCATIONid = dbo.Ledgers.acc_LOCATIONid AND dbo.CONTRA.CONTRA_YEARid = dbo.Ledgers.acc_YEARid AND dbo.CONTRA.CONTRA_ledgerid = dbo.Ledgers.acc_id  ", tempcondition & " group by dbo.CONTRA.CONTRA_no , dbo.Ledgers.acc_cmpname ,dbo.CONTRA.CONTRA_date, ISNULL(CONTRA.CONTRA_CHQNO,''),  dbo.Contra.contra_remarks order by dbo.CONTRA.CONTRA_no")
