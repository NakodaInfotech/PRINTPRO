...
Public Class OpeningPurchaseOrderGridDetails
    ...
    Sub fillgrid()
        Try
            ...
            Dim dttable As DataTable = OBJPO.selectopningpurchaseorder()
    ...
    Private Sub EXCELEXPORT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EXCELEXPORT.Click
        Try
            ...
            Dim PATH As String = Application.StartupPath & "\OpeningPurchaseOrder Details.XLS"
            ...
            For Each proc In System.Diagnostics.Process.GetProcessesByName("Excel")
                proc.Kill()
            Next
            opti.SheetName = "OpeningPurchaseOrder  Details"
            GridInvoice.ExportToXls(PATH, opti)
            EXCELCMPHEADER(PATH, "OpeningPurchaseOrder  Details", GridInvoice.VisibleColumns.Count + GridInvoice.GroupCount)
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
