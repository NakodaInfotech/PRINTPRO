...
Public Class OpeningBills
    ...
    Private Sub txtamt_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TXTAMT.KeyPress, TXTQTY.KeyPress, TXTTOTALAMT.KeyPress, TXTCGSTPER.KeyPress, TXTCGSTAMT.KeyPress, TXTSGSTPER.KeyPress, TXTSGSTAMT.KeyPress, TXTIGSTPER.KeyPress, TXTIGSTAMT.KeyPress, TXTGRANDTOTAL.KeyPress
        ...
        Try
            ...
            If GRIDDOUBLECLICK = False Then
                If CHKDISPUTE.Checked = True Then
                    GRIDOPENING.Rows.Add(TXTSRNO.Text.Trim, CMBTYPE.Text.Trim, CMBREGISTER.Text.Trim, TXTBILLNO.Text.Trim, TXTYEAR.Text.Trim, Format(BILLDATE.Value.Date, "dd/MM/yyyy"), TXTCRDAYS.Text.Trim, Format(DUEDATE.Value.Date, "dd/MM/yyyy"), CMBAGENT.Text.Trim, TXTREMARKS.Text.Trim, 1, CMBDELIVERYAT.Text.Trim, TXTPONO.Text.Trim, Val(TXTQTY.Text.Trim), Val(TXTTOTALAMT.Text.Trim), Val(TXTCHARGES.Text.Trim), Val(TXTTAXABLEAMT.Text.Trim), Val(TXTCGSTPER.Text.Trim), Val(TXTCGSTAMT.Text.Trim), Val(TXTSGSTPER.Text.Trim), Val(TXTSGSTAMT.Text.Trim), Val(TXTIGSTPER.Text.Trim), Val(TXTIGSTAMT.Text.Trim), Val(TXTGRANDTOTAL.Text.Trim), Val(TXTAMT.Text.Trim), 0, 0, 0, 0, "", 0)
                Else
                    GRIDOPENING.Rows.Add(TXTSRNO.Text.Trim, CMBTYPE.Text.Trim, CMBREGISTER.Text.Trim, TXTBILLNO.Text.Trim, TXTYEAR.Text.Trim, Format(BILLDATE.Value.Date, "dd/MM/yyyy"), TXTCRDAYS.Text.Trim, Format(DUEDATE.Value.Date, "dd/MM/yyyy"), CMBAGENT.Text.Trim, TXTREMARKS.Text.Trim, 0, CMBDELIVERYAT.Text.Trim, TXTPONO.Text.Trim, Val(TXTQTY.Text.Trim), Val(TXTTOTALAMT.Text.Trim), Val(TXTCHARGES.Text.Trim), Val(TXTTAXABLEAMT.Text.Trim), Val(TXTCGSTPER.Text.Trim), Val(TXTCGSTAMT.Text.Trim), Val(TXTSGSTPER.Text.Trim), Val(TXTSGSTAMT.Text.Trim), Val(TXTIGSTPER.Text.Trim), Val(TXTIGSTAMT.Text.Trim), Val(TXTGRANDTOTAL.Text.Trim), Val(TXTAMT.Text.Trim), 0, 0, 0, 0, "", 0)
                End If
                getsrno(GRIDOPENING)
            Else
                ...
                GRIDOPENING.Item(GPONO.Index, TEMPROW).Value = TXTPONO.Text.Trim
                GRIDOPENING.Item(GQTY.Index, TEMPROW).Value = Format(Val(TXTQTY.Text.Trim), "0.00")
    ...
    Private Sub GRIDOPENING_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles GRIDOPENING.CellDoubleClick
        Try
            ...
            If e.RowIndex >= 0 And GRIDOPENING.Item(GSRNO.Index, e.RowIndex).Value <> Nothing Then
                ...
                TXTPONO.Text = GRIDOPENING.Item(GPONO.Index, e.RowIndex).Value.ToString
                TXTQTY.Text = GRIDOPENING.Item(GQTY.Index, e.RowIndex).Value.ToString
