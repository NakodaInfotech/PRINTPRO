...
Partial Class UploadExcelStatement
    ...
    Friend WithEvents TXTCRCOL As TextBox
    ...
    Friend WithEvents TXTDRCOL As TextBox
    Friend WithEvents Label5 As Label
    Friend WithEvents TXTCHQCOL As TextBox
    Friend WithEvents Label4 As Label
    Friend WithEvents TXTDATECOL As TextBox
