...
Public Class PurchaseReturnChallanGridDetails
    ...
    Private Sub PurchaseReturnChallanGridDetails_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub PurchaseReturnChallanGridDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Sub FILLGRID()
        Try
            Dim OBJPURCH As New ClsPurchaseReturnChallan
            OBJPURCH.alParaval.Add(0)
            OBJPURCH.alParaval.Add(YearId)
            Dim DT As DataTable = OBJPURCH.SELECTPURCHASERETURNCHALLAN()
