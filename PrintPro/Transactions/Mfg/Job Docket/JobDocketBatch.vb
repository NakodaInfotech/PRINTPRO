            ...
            If edit = True Then
                ...
                If DTTABLE1.Rows.Count > 0 Then
                    For Each DR As DataRow In DTTABLE1.Rows
                        ...
                        TXTBOXQTY.Text = Convert.ToString(DR("BOXQTY"))
                        TXTTRAYQTY.Text = Convert.ToString(DR("TRAYQTY"))
