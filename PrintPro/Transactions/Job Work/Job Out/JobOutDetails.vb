...
Public Class JobOutDetails
    ...
    Private Sub cmdexit_Click(sender As Object, e As EventArgs) Handles cmdexit.Click
        Me.Close()
    End Sub
    Private Sub JobOutDetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub JobOutDetails_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Sub FILLGRID()
        Try
            Dim OBJDEPT As New ClsJobOut
            Dim DT As DataTable = OBJDEPT.SELECTJOBOUT(TEMPJONO, CmpId, YearId)
    ...
    Private Sub TOOLEXCEL_Click_1(sender As Object, e As EventArgs) Handles TOOLEXCEL.Click
        Try
