...
Public Class SendWhatsapp
    ...
    Sub FILLGRID()
        Try
            ...
            Dim DTDESIGN As DataTable = objclsCMST.search(" DISTINCT CAST(0 AS BIT) AS CHK, ISNULL(ITEMMASTER.item_name, '') AS ITEMNAME, ISNULL(DESIGNMASTER.DESIGN_NO, '') AS DESIGNNO, '' AS COLOR, ITEMDESIGNIMAGE.ITEMDESIGN_NO AS CATALOGNO ", "", " ITEMDESIGNIMAGE INNER JOIN ITEMMASTER ON ITEMDESIGNIMAGE.ITEMDESIGN_ITEMID = ITEMMASTER.item_id INNER JOIN DESIGNMASTER ON ITEMDESIGNIMAGE.ITEMDESIGN_DESIGNID = DESIGNMASTER.DESIGN_id " & JOINCLAUSE, " and ITEMDESIGNIMAGE.ITEMDESIGN_YEARID = " & YearId)
            ...
            If FRMSTRING = "DIRECTWHATSAPP" Then
                For i As Integer = 0 To GRIDDESIGN.RowCount - 1
                    ...
                    If Convert.ToBoolean(dtrow("CHK")) = True Then
                        ...
                        Dim DTIMG As DataTable = OBJCMN.search("ITEMDESIGN_IMAGE1 AS PHOTO", "", " ITEMDESIGNIMAGE ", " AND ITEMDESIGN_NO = " & dtrow("CATALOGNO") & " AND ITEMDESIGN_YEARID = " & YearId)
