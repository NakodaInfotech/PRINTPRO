...
Public Class ChallanFilter
    ...
    Sub fillcmb()
        Try
            ...
            If CMBTRANSNAME.Text.Trim <> "" Then fillname(CMBTRANSNAME, edit, "and GROUPMASTER.GROUP_SECONDARY = 'SUNDRY creditors' AND ACC_TYPE = 'TRANSPORT'")
    ...
    Private Sub CMBTRANSNAME_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMBTRANSNAME.Enter
        Try
            If CMBNAME.Text.Trim = "" Then fillname(CMBTRANSNAME, edit, " AND GROUPMASTER.GROUP_SECONDARY = 'SUNDRY CREDITORS' and LEDGERS.ACC_TYPE = 'TRANSPORT'")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub

    Private Sub CMBTRANSNAME_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles CMBTRANSNAME.Validating
        Try
            If CMBNAME.Text.Trim <> "" Then namevalidate(CMBNAME, CMBCODE, e, Me, txtadd, " AND GROUPMASTER.GROUP_SECONDARY = 'SUNDRY CREDITORS'", "Sundry DEBTORS", "TRANSPORT")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Private Sub ChallanFilter_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub ChallanFilter_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            fillcmb()
        Catch ex As Exception
            Throw ex
    ...
    Private Sub cmdshow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdshow.Click
        Try
            Dim OBJORDER As New ChallanDesign
            OBJORDER.MdiParent = MDIMain
            OBJORDER.WHERECLAUSE = "  {CHALLANMASTER.CHALLAN_yearid}=" & YearId
            ...
            If CMBTRANSNAME.Text <> "" Then OBJORDER.WHERECLAUSE = OBJORDER.WHERECLAUSE & " AND {TRANSLEDGERS.ACC_CMPNAME}='" & CMBTRANSNAME.Text.Trim & "'"


            If RDDETAILS.Checked = True Then
                If CHKSUMMARY.CheckState = CheckState.Unchecked Then OBJORDER.FRMSTRING = "CHDTLS" Else OBJORDER.FRMSTRING = "CHSUMM"
            ...
            ElseIf RBDISPATCH.Checked = True Then
                If CHKSUMMARY.CheckState = CheckState.Unchecked Then OBJORDER.FRMSTRING = "DAILYDESPATCH"

            ElseIf RDGOODDESPATCH.Checked = True Then
                If CHKSUMMARY.CheckState = CheckState.Unchecked Then OBJORDER.FRMSTRING = "GOODDESPATCH"

            ElseIf RBTRANS.Checked = True Then
                If CHKSUMMARY.CheckState = CheckState.Unchecked Then OBJORDER.FRMSTRING = "TRANSWISEDTLS" Else OBJORDER.FRMSTRING = "TRANSWISESUMM"
            End If
