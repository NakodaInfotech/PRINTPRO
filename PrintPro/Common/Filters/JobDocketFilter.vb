...
Public Class JobDocketFilter
    ...
    Private Sub JobDocketFilter_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            fillcmb()
        Catch ex As Exception
            Throw ex
    ...
    Private Sub JobDocketFilter_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
    ...
    Private Sub cmdshow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdshow.Click
        Try
            Dim OBJORDER As New DocketDesign
            OBJORDER.MdiParent = MDIMain
            OBJORDER.WHERECLAUSE = " {JOBMASTER.JOB_cmpid}=" & CmpId & " and {JOBMASTER.JOB_yearid}=" & YearId
            ...
            If RDDETAILS.Checked = True Then
                If CHKSUMMARY.CheckState = CheckState.Unchecked Then OBJORDER.FRMSTRING = "JOBDTLS" Else OBJORDER.FRMSTRING = "JOBSUMM"
