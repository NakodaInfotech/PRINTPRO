...
Public Class HSNMaster
        ...
        Try
            ...
            If EDIT = True Then
                ...
                If DT.Rows.Count > 0 Then
                    ...
                    TXTEXPCGST.Text = DT.Rows(0).Item("EXPCGST")
                    TXTEXPSGST.Text = DT.Rows(0).Item("EXPSGST")
                    TXTEXPIGST.Text = DT.Rows(0).Item("EXPIGST")
    ...
    Private Sub CMDSAVE_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMDSAVE.Click
        Try
            ...
            alParaval.Add(Val(TXTEXPCGST.Text.Trim))
            alParaval.Add(Val(TXTEXPSGST.Text.Trim))
            alParaval.Add(Val(TXTEXPIGST.Text.Trim))
    ...
    Private Sub TXTCGST_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TXTSGST.KeyPress, TXTIGST.KeyPress, TXTCGST.KeyPress, TXTEXPSGST.KeyPress, TXTEXPIGST.KeyPress, TXTEXPCGST.KeyPress
        Try
    ...
    Private Sub TXTCGST_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TXTCGST.Validating, TXTSGST.Validating, TXTIGST.Validating, TXTEXPCGST.Validating, TXTEXPSGST.Validating, TXTEXPIGST.Validating
        Try
            If Val(TXTCGST.Text.Trim) > 100 Or Val(TXTSGST.Text.Trim) > 100 Or Val(TXTIGST.Text.Trim) > 100 Or Val(TXTEXPCGST.Text.Trim) > 100 Or Val(TXTEXPSGST.Text.Trim) > 100 Or Val(TXTEXPIGST.Text.Trim) > 100 Then
                e.Cancel = True
