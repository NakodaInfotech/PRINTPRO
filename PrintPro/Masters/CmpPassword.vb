            ...
            Else
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    Else
                        ...
                        'TABLE NOT PRESENT IN DATAABASE
                        'dt = objcmn.search(" CON_MANUALINVOICING AS INVOICE, CON_SMSTOPARTY AS SMS,CON_PRINTDIRECT AS PRINTDIRECT,CON_CHKPRINTING AS CHKPRINTING,CON_SHOWPARTYRATES AS PARTYRATE", "", " CONFIGURATION", " AND CON_CMPID = " & CmpId & " AND CON_LOCATIONID = " & Locationid & " AND CON_YEARID = " & YearId)


                        'If dt.Rows.Count > 0 Then
                        '    MANUALINVOICE = dt.Rows(0).Item("INVOICE").ToString
                        '    SMSPARTY = dt.Rows(0).Item("SMS").ToString
                        '    PRINTDIRECT = dt.Rows(0).Item("PRINTDIRECT").ToString
                        '    CHKPRINTING = dt.Rows(0).Item("CHKPRINTING").ToString
                        '    SHOWRATES = dt.Rows(0).Item("PARTYRATE").ToString
