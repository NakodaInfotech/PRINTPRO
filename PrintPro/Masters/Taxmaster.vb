...
Public Class Taxmaster
    ...
    Private Function errorvalid() As Boolean
        ...
        If RBCST.Checked = False And RBVAT.Checked = False And RBOTHER.Checked = False Then
            Ep.SetError(txttax, "Select CST/VAT/Other Chgs")
            bln = False
        End If
    ...
    Private Sub Taxmaster_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If edit = True Then
            ...
            dttable = objCommon.search(" tax_name,tax_tax, tax_remarks, TAX_ISVAT AS ISVAT, TAX_ISCST AS ISCST ", "", "TaxMaster", " and tax_id = " & tempid)
