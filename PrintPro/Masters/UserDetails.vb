...
Public Class UserDetails
    ...
    Sub fillnamegrid()
        Try
            ...
            Dim dt As DataTable = objcmn.search(" DISTINCT User_Name as [UserName]", "", "USERMASTER", " and USERMASTER.USER_cmpid= " & CmpId & " ORDER BY USER_NAME ")
