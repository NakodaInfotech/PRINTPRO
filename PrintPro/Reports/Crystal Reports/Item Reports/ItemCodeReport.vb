...
Public Class ItemCodeReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.ItemCodeReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedItemCodeReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ItemCodeReport = New ItemCodeReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
