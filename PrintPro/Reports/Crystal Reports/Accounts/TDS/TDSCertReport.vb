...
Public Class TDSCertReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.TDSCertReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTDSCertReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TDSCertReport = New TDSCertReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
