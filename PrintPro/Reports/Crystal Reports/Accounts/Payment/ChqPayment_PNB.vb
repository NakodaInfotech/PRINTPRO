...
Public Class ChqPayment_PNB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.ChqPayment_PNB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_PNB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_PNB = New ChqPayment_PNB()
        rpt.Site = Me.Site
        Return rpt
    End Function
