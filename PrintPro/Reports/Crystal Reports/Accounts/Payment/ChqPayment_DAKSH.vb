...
Public Class ChqPayment_DAKSH
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.ChqPayment_DAKSH.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_DAKSH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_DAKSH = New ChqPayment_DAKSH()
        rpt.Site = Me.Site
        Return rpt
    End Function
