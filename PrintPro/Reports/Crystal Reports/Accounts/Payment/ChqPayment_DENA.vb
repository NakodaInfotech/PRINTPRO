...
Public Class ChqPayment_DENA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.ChqPayment_DENA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_DENA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_DENA = New ChqPayment_DENA()
        rpt.Site = Me.Site
        Return rpt
    End Function
