...
Public Class ChqPayment_COSMOS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.ChqPayment_COSMOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_COSMOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_COSMOS = New ChqPayment_COSMOS()
        rpt.Site = Me.Site
        Return rpt
    End Function
