...
Public Class ChqPayment_BOB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.ChqPayment_BOB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_BOB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_BOB = New ChqPayment_BOB()
        rpt.Site = Me.Site
        Return rpt
    End Function
