...
Public Class ChqPayment_IDBI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.ChqPayment_IDBI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_IDBI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_IDBI = New ChqPayment_IDBI()
        rpt.Site = Me.Site
        Return rpt
    End Function
