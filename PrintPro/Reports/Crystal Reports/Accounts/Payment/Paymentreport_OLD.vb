...
Public Class Paymentreport_OLD
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.Paymentreport_OLD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPaymentreport_OLD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Paymentreport_OLD = New Paymentreport_OLD()
        rpt.Site = Me.Site
        Return rpt
    End Function
