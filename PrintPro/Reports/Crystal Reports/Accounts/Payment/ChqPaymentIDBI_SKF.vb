...
Public Class ChqPaymentIDBI_SKF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.ChqPaymentIDBI_SKF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPaymentIDBI_SKF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPaymentIDBI_SKF = New ChqPaymentIDBI_SKF()
        rpt.Site = Me.Site
        Return rpt
    End Function
