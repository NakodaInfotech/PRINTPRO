...
Public Class ChqPayment_MAHESH
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.ChqPayment_MAHESH.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_MAHESH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_MAHESH = New ChqPayment_MAHESH()
        rpt.Site = Me.Site
        Return rpt
    End Function
