...
Public Class Receipt_BankSlip
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.Receipt_BankSlip.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReceipt_BankSlip
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Receipt_BankSlip = New Receipt_BankSlip()
        rpt.Site = Me.Site
        Return rpt
    End Function
