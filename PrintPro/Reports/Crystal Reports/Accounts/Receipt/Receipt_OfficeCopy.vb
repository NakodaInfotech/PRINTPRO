...
Public Class Receipt_OfficeCopy
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.Receipt_OfficeCopy.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReceipt_OfficeCopy
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Receipt_OfficeCopy = New Receipt_OfficeCopy()
        rpt.Site = Me.Site
        Return rpt
    End Function
