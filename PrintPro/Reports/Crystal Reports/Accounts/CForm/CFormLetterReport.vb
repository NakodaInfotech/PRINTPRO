...
Public Class CFormLetterReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.CFormLetterReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCFormLetterReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CFormLetterReport = New CFormLetterReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
