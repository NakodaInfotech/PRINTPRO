...
Public Class StockRegisterRate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.StockRegisterRate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockRegisterRate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockRegisterRate = New StockRegisterRate()
        rpt.Site = Me.Site
        Return rpt
    End Function
