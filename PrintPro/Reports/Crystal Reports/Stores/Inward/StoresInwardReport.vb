...
Public Class StoresInwardReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.StoresInwardReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStoresInwardReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StoresInwardReport = New StoresInwardReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
