...
Public Class JobDocketPartyWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "JobDocketPartyWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.JobDocketPartyWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJobDocketPartyWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JobDocketPartyWiseDetails = New JobDocketPartyWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
