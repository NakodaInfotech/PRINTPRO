...
Public Class JobDocketMonthWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.JobDocketMonthWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJobDocketMonthWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JobDocketMonthWise = New JobDocketMonthWise()
        rpt.Site = Me.Site
        Return rpt
    End Function
