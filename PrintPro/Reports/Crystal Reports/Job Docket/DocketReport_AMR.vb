...
Public Class DocketReport_AMR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.DocketReport_AMR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDocketReport_AMR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DocketReport_AMR = New DocketReport_AMR()
        rpt.Site = Me.Site
        Return rpt
    End Function
