...
Public Class BatchReport_Rutvij
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.BatchReport_Rutvij.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBatchReport_Rutvij
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BatchReport_Rutvij = New BatchReport_Rutvij()
        rpt.Site = Me.Site
        Return rpt
    End Function
