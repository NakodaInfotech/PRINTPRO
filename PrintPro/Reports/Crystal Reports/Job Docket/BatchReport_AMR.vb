...
Public Class BatchReport_AMR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.BatchReport_AMR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBatchReport_AMR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BatchReport_AMR = New BatchReport_AMR()
        rpt.Site = Me.Site
        Return rpt
    End Function
