...
Public Class DeliveryDetailsReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DeliveryDetailsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.DeliveryDetailsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDeliveryDetailsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DeliveryDetailsReport = New DeliveryDetailsReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
