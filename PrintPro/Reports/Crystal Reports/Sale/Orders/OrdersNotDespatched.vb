...
Public Class OrdersNotDespatched
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "OrdersNotDespatched.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.OrdersNotDespatched.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdersNotDespatched
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdersNotDespatched = New OrdersNotDespatched()
        rpt.Site = Me.Site
        Return rpt
    End Function
