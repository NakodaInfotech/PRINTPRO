...
Public Class COAReportforRutvij
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.COAReportforRutvij.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCOAReportforRutvij
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As COAReportforRutvij = New COAReportforRutvij()
        rpt.Site = Me.Site
        Return rpt
    End Function
