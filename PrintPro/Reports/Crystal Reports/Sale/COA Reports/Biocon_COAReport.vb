...
Public Class Biocon_COAReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.Biocon_COAReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBiocon_COAReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Biocon_COAReport = New Biocon_COAReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
