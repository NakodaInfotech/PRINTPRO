...
Public Class FAMY_CARE__COAReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FAMY_CARE _COAReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.FAMY_CARE _COAReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFAMY_CARE__COAReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FAMY_CARE__COAReport = New FAMY_CARE__COAReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
