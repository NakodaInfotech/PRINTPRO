...
Public Class IPCA_COAReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.IPCA_COAReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIPCA_COAReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IPCA_COAReport = New IPCA_COAReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
