...
Public Class MSN_COAReportforAMR
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MSN_COAReportforAMR.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.MSN_COAReportforAMR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMSN_COAReportforAMR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MSN_COAReportforAMR = New MSN_COAReportforAMR()
        rpt.Site = Me.Site
        Return rpt
    End Function
