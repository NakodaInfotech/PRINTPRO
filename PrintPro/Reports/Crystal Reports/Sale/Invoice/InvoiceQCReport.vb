...
Public Class InvoiceQCReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.InvoiceQCReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceQCReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceQCReport = New InvoiceQCReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
