...
Public Class InvoiceReportNew
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.InvoiceReportNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceReportNew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceReportNew = New InvoiceReportNew()
        rpt.Site = Me.Site
        Return rpt
    End Function
