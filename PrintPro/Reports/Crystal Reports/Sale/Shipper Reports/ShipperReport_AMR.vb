...
Public Class ShipperReport_AMR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.ShipperReport_AMR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShipperReport_AMR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShipperReport_AMR = New ShipperReport_AMR()
        rpt.Site = Me.Site
        Return rpt
    End Function
