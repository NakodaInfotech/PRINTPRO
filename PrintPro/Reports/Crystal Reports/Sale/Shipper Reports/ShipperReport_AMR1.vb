...
Public Class ShipperReport_AMR1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.ShipperReport_AMR1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShipperReport_AMR1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShipperReport_AMR1 = New ShipperReport_AMR1()
        rpt.Site = Me.Site
        Return rpt
    End Function
