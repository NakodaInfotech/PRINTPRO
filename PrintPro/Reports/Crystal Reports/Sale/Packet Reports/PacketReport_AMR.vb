...
Public Class PacketReport_AMR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.PacketReport_AMR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPacketReport_AMR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PacketReport_AMR = New PacketReport_AMR()
        rpt.Site = Me.Site
        Return rpt
    End Function
