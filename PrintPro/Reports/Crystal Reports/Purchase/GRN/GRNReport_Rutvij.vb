...
Public Class GRNReport_Rutvij
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.GRNReport_Rutvij.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNReport_Rutvij
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNReport_Rutvij = New GRNReport_Rutvij()
        rpt.Site = Me.Site
        Return rpt
    End Function
