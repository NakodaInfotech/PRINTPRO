...
Public Class GRNDetailReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.GRNDetailReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNDetailReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNDetailReport = New GRNDetailReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
