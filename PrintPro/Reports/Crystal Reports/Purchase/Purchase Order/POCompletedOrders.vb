...
Public Class POCompletedOrders
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.POCompletedOrders.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPOCompletedOrders
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As POCompletedOrders = New POCompletedOrders()
        rpt.Site = Me.Site
        Return rpt
    End Function
