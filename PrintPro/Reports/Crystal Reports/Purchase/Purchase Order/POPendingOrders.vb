...
Public Class POPendingOrders
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.POPendingOrders.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPOPendingOrders
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As POPendingOrders = New POPendingOrders()
        rpt.Site = Me.Site
        Return rpt
    End Function
