...
Public Class POItemWiseDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.POItemWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPOItemWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As POItemWiseDetails = New POItemWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
