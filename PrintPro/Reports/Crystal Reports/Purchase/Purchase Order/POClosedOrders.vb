...
Public Class POClosedOrders
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.POClosedOrders.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPOClosedOrders
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As POClosedOrders = New POClosedOrders()
        rpt.Site = Me.Site
        Return rpt
    End Function
