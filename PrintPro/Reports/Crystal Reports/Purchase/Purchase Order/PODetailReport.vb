...
Public Class PODetailReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.PODetailReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPODetailReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PODetailReport = New PODetailReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
