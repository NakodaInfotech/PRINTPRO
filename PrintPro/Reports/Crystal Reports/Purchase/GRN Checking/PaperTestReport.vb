...
Public Class PaperTestReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintPro.PaperTestReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPaperTestReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PaperTestReport = New PaperTestReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
