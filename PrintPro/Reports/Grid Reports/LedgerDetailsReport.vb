...
Public Class LedgerDetailsReport
    ...
    Sub fillgrid(ByVal WHERECLAUSE As String)
        Try
            ...
            '  Dim dt As DataTable = objclsCMST.search(" ISNULL(LEDGERS.Acc_cmpname, '') AS CMPNAME, ISNULL(LEDGERS.Acc_name, '') AS NAME, ISNULL(LEDGERS.Acc_code, '') AS CODE, ISNULL(GROUPMASTER.group_name, '') AS GROUPNAME,  ISNULL(GROUPMASTER.group_secondary, '') AS SECONDARY, ISNULL(LEDGERS.Acc_TYPE, '') AS TYPE, ISNULL(LEDGERS.Acc_opbal, 0) AS OPBAL, ISNULL(LEDGERS.Acc_drcr, '') AS DRCR, ISNULL(AREAMASTER.area_name, '') AS AREA, ISNULL(DISTRICTMASTER.DISTRICT_name, '') AS DISTRICT, ISNULL(CITYMASTER.city_name, '') AS CITY, ISNULL(STATEMASTER.state_name, '') AS STATE, ISNULL(COUNTRYMASTER.country_name, '')  AS COUNTRY, ISNULL(LEDGERS.Acc_resino, '') AS RESINO, ISNULL(LEDGERS.Acc_altno, '') AS ALTNO, ISNULL(LEDGERS.Acc_phone, '') AS PHONENO, ISNULL(LEDGERS.Acc_mobile, '') AS MOBILE, ISNULL(LEDGERS.Acc_fax,'') AS FAX, ISNULL(LEDGERS.Acc_website, '') AS WEBSITE, ISNULL(LEDGERS.Acc_email, '') AS EMAIL, ISNULL(LEDGERS.Acc_panno, '') AS PANNO, ISNULL(LEDGERS.Acc_add, '') AS [ADD], ISNULL(LEDGERS.Acc_tinno, '')  AS TANNO, ISNULL(LEDGERS.Acc_cstno, '') AS CSTNO, ISNULL(LEDGERS.Acc_vatno, '') AS VATNO, ISNULL(LEDGERS.ACC_GSTIN, '') AS GSTIN, ISNULL(AGENTLEDGERS.Acc_cmpname, '') AS AGENTNAME,ISNULL(TERMMASTER.TERM_NAME, '') AS TERM, ISNULL(PARTYBANKMASTER.PARTYBANK_name, '') AS PARTYBANK, ISNULL(LEDGERS.ACC_ACCOUNTTYPE, '') AS ACCOUNTTYPE, ISNULL(LEDGERS.ACC_ACCOUNTNO, '')  AS ACCOUNTNO, ISNULL(LEDGERS.ACC_IFSC, '') AS IFSCCODE, ISNULL(LEDGERS.ACC_BRANCH, '') AS BRANCH, ISNULL(BANKCITY.city_name, '') AS BANKCITY, ISNULL(LEDGERS.Acc_remarks, '') AS REMARKS,  ISNULL(LEDGERS.ACC_INTPER, 0) AS INTPER, ISNULL(LEDGERS.Acc_crdays, 0) AS CRDAYS, ISNULL(LEDGERS.Acc_crlimit, 0) AS CRLIMIT, ISNULL(ACCOUNTSMASTER_TDS.ACC_TDSPER, 0) AS TDSPER,  ISNULL(TRANSLEDGERS.Acc_cmpname, '') AS TRANSPORT, ISNULL(LEDGERS.Acc_name, '') AS CONTACT, ISNULL(DELIVERYCITY.city_name, '') AS DELIVERYAT, ISNULL(LEDGERS.Acc_zipcode, '') AS ZIPCODE,  ISNULL(LEDGERS.ACC_DELIVERYPINCODE, '') AS DELIVERYPINCODE, ISNULL(CAST(LEDGERS.Acc_shippingadd AS VARCHAR(500)), '') AS SHIPPINGADD, ISNULL(LEDGERS.ACC_KMS, 0) AS KMS,   ISNULL(LEDGERS.ACC_CDPER, 0) AS CDPER, ISNULL(LEDGERS.ACC_DISC, 0) AS DISC, ISNULL(LEDGERS.ACC_AGENTCOMM, 0) AS BROKERAGE, ISNULL(LEDGERS.ACC_WHATSAPPNO, '') AS WHATSAPPNO,   ISNULL(LEDGERS.ACC_RD, 0) AS RATEDIFF, ISNULL(GROUPOFCOMPANIESMASTER.GOC_NAME, '') AS GROUPOFCOMPANIES, ISNULL(LEDGERS.Acc_range, '') AS MSMENO, ISNULL(LEDGERS.ACC_BLOCKED, 0) AS BLOCKED, USER_NAME AS USERNAME", "", "   LEDGERS INNER JOIN GROUPMASTER ON LEDGERS.Acc_groupid = GROUPMASTER.group_id LEFT OUTER JOIN  CITYMASTER AS BANKCITY ON LEDGERS.ACC_BANKCITYID = BANKCITY.city_id LEFT OUTER JOIN GROUPOFCOMPANIESMASTER ON LEDGERS.ACC_GOCID = GROUPOFCOMPANIESMASTER.GOC_ID LEFT OUTER JOIN  PARTYBANKMASTER ON LEDGERS.ACC_BANKID = PARTYBANKMASTER.PARTYBANK_id LEFT OUTER JOIN  CITYMASTER AS CITYMASTER ON LEDGERS.Acc_cityid = CITYMASTER.city_id LEFT OUTER JOIN  CITYMASTER AS DELIVERYCITY ON LEDGERS.ACC_DELIVERYATID = DELIVERYCITY.city_id LEFT OUTER JOIN AREAMASTER ON LEDGERS.Acc_areaid = AREAMASTER.area_id LEFT OUTER JOIN  DISTRICTMASTER ON LEDGERS.ACC_DISTRICTID = DISTRICTMASTER.DISTRICT_id LEFT OUTER JOIN STATEMASTER ON LEDGERS.Acc_stateid = STATEMASTER.state_id LEFT OUTER JOIN COUNTRYMASTER ON LEDGERS.Acc_countryid = COUNTRYMASTER.country_id LEFT OUTER JOIN  LEDGERS AS AGENTLEDGERS ON LEDGERS.ACC_AGENTID = AGENTLEDGERS.Acc_id LEFT OUTER JOIN TERMMASTER ON LEDGERS.ACC_TERMID = TERMMASTER.TERM_ID LEFT OUTER JOIN LEDGERS AS TRANSLEDGERS ON LEDGERS.ACC_TRANSID = TRANSLEDGERS.Acc_id LEFT OUTER JOIN ACCOUNTSMASTER_TDS ON LEDGERS.Acc_id = ACCOUNTSMASTER_TDS.ACC_ID LEFT OUTER JOIN USERMASTER ON LEDGERS.ACC_USERID = USER_ID", WHERECLAUSE & " AND LEDGERS.ACC_YEARID = " & YearId & " ORDER BY LEDGERS.ACC_CMPNAME")
            ' Dim dt As DataTable = objclsCMST.search(" ISNULL(LEDGERS.Acc_cmpname, '') AS CMPNAME, ISNULL(LEDGERS.Acc_name, '') AS NAME, ISNULL(LEDGERS.Acc_code, '') AS CODE, ISNULL(GROUPMASTER.group_name, '') AS GROUPNAME, ISNULL(GROUPMASTER.group_secondary, '') AS SECONDARY, ISNULL(LEDGERS.Acc_TYPE, '') AS TYPE, ISNULL(LEDGERS.Acc_opbal, 0) AS OPBAL, ISNULL(LEDGERS.Acc_drcr, '') AS DRCR, ISNULL(AREAMASTER.area_name, '') AS AREA, ISNULL(DISTRICTMASTER.DISTRICT_name, '') AS DISTRICT, ISNULL(CITYMASTER.city_name, '') AS CITY, ISNULL(STATEMASTER.state_name, '') AS STATE, ISNULL(COUNTRYMASTER.country_name, '') AS COUNTRY, ISNULL(LEDGERS.Acc_resino, '') AS RESINO, ISNULL(LEDGERS.Acc_altno, '') AS ALTNO, ISNULL(LEDGERS.Acc_phone, '') AS PHONENO, ISNULL(LEDGERS.Acc_mobile, '') AS MOBILE, ISNULL(LEDGERS.Acc_fax, '') AS FAX, ISNULL(LEDGERS.Acc_website, '') AS WEBSITE, ISNULL(LEDGERS.Acc_email, '') AS EMAIL, ISNULL(LEDGERS.Acc_panno, '') AS PANNO, ISNULL(LEDGERS.Acc_add, '') AS [ADD], ISNULL(LEDGERS.Acc_tinno, '') AS TANNO, ISNULL(LEDGERS.Acc_cstno, '') AS CSTNO, ISNULL(LEDGERS.Acc_vatno, '') AS VATNO, ISNULL(LEDGERS.ACC_GSTIN, '') AS GSTIN, ISNULL(AGENTLEDGERS.Acc_cmpname, '') AS AGENTNAME, ISNULL(TERMMASTER.TERM_NAME, '') AS TERM, ISNULL(PARTYBANKMASTER.PARTYBANK_name, '') AS PARTYBANK, ISNULL(LEDGERS.ACC_ACCOUNTTYPE, '') AS ACCOUNTTYPE, ISNULL(LEDGERS.ACC_ACCOUNTNO, '') AS ACCOUNTNO, ISNULL(LEDGERS.ACC_IFSC, '') AS IFSCCODE, ISNULL(LEDGERS.ACC_BRANCH, '') AS BRANCH, ISNULL(BANKCITY.city_name, '') AS BANKCITY, ISNULL(LEDGERS.Acc_remarks, '') AS REMARKS, ISNULL(LEDGERS.ACC_INTPER, 0) AS INTPER, ISNULL(LEDGERS.Acc_crdays, 0) AS CRDAYS, ISNULL(LEDGERS.Acc_crlimit, 0) AS CRLIMIT, ISNULL(ACCOUNTSMASTER_TDS.ACC_TDSPER, 0) AS TDSPER, ISNULL(TRANSLEDGERS.Acc_cmpname, '') AS TRANSPORT, ISNULL(LEDGERS.Acc_name, '') AS CONTACT, ISNULL(DELIVERYCITY.city_name, '') AS DELIVERYAT, ISNULL(LEDGERS.Acc_zipcode, '') AS ZIPCODE, ISNULL(LEDGERS.ACC_DELIVERYPINCODE, '') AS DELIVERYPINCODE, ISNULL(CAST(LEDGERS.Acc_shippingadd AS VARCHAR(500)), '') AS SHIPPINGADD, ISNULL(LEDGERS.ACC_KMS, 0) AS KMS, ISNULL(LEDGERS.ACC_CDPER, 0) AS CDPER, ISNULL(LEDGERS.ACC_DISC, 0) AS DISC, ISNULL(LEDGERS.ACC_AGENTCOMM, 0) AS BROKERAGE, ISNULL(LEDGERS.ACC_WHATSAPPNO, '') AS WHATSAPPNO, ISNULL(LEDGERS.ACC_RD, 0) AS RATEDIFF, ISNULL(GROUPOFCOMPANIESMASTER.GOC_NAME, '') AS GROUPOFCOMPANIES, ISNULL(LEDGERS.ACC_MSMENO, '') AS MSMENO, ISNULL(LEDGERS.Acc_range, '') AS TALLYLEDGER, ISNULL(LEDGERS.ACC_BLOCKED, 0) AS BLOCKED, USERMASTER.User_Name AS USERNAME, ISNULL(LEDGERS.ACC_EXMILLLESS, 0) AS EXMILLDISC, ISNULL(ACCOUNTSMASTER_TDS.ACC_SECTION, '') AS TDSSECTION, ISNULL(LEDGERS.ACC_TDSCOMPANY, '') AS TDSCOMPANY, ISNULL(LEDGERS.ACC_COMMISSION, 0) AS COMMISSION ", "", "    LEDGERS INNER JOIN GROUPMASTER ON LEDGERS.Acc_groupid = GROUPMASTER.group_id LEFT OUTER JOIN CITYMASTER AS BANKCITY ON LEDGERS.ACC_BANKCITYID = BANKCITY.city_id LEFT OUTER JOIN GROUPOFCOMPANIESMASTER ON LEDGERS.ACC_GOCID = GROUPOFCOMPANIESMASTER.GOC_ID LEFT OUTER JOIN PARTYBANKMASTER ON LEDGERS.ACC_BANKID = PARTYBANKMASTER.PARTYBANK_id LEFT OUTER JOIN CITYMASTER AS CITYMASTER ON LEDGERS.Acc_cityid = CITYMASTER.city_id LEFT OUTER JOIN CITYMASTER AS DELIVERYCITY ON LEDGERS.ACC_DELIVERYATID = DELIVERYCITY.city_id LEFT OUTER JOIN AREAMASTER ON LEDGERS.Acc_areaid = AREAMASTER.area_id LEFT OUTER JOIN DISTRICTMASTER ON LEDGERS.ACC_DISTRICTID = DISTRICTMASTER.DISTRICT_id LEFT OUTER JOIN STATEMASTER ON LEDGERS.Acc_stateid = STATEMASTER.state_id LEFT OUTER JOIN COUNTRYMASTER ON LEDGERS.Acc_countryid = COUNTRYMASTER.country_id LEFT OUTER JOIN LEDGERS AS AGENTLEDGERS ON LEDGERS.ACC_AGENTID = AGENTLEDGERS.Acc_id LEFT OUTER JOIN TERMMASTER ON LEDGERS.ACC_TERMID = TERMMASTER.TERM_ID LEFT OUTER JOIN LEDGERS AS TRANSLEDGERS ON LEDGERS.ACC_TRANSID = TRANSLEDGERS.Acc_id LEFT OUTER JOIN ACCOUNTSMASTER_TDS ON LEDGERS.Acc_id = ACCOUNTSMASTER_TDS.ACC_ID LEFT OUTER JOIN USERMASTER ON LEDGERS.Acc_userid = USERMASTER.User_id", WHERECLAUSE & " AND LEDGERS.ACC_YEARID = " & YearId & " ORDER BY LEDGERS.ACC_CMPNAME")
            Dim dt As DataTable = objclsCMST.search(" ISNULL(LEDGERS.Acc_cmpname, '') AS CMPNAME, ISNULL(LEDGERS.Acc_name, '') AS NAME, ISNULL(LEDGERS.Acc_code, '') AS CODE, ISNULL(GROUPMASTER.group_name, '') AS GROUPNAME, ISNULL(GROUPMASTER.group_secondary, '') AS SECONDARY, ISNULL(LEDGERS.Acc_TYPE, '') AS TYPE, ISNULL(LEDGERS.Acc_opbal, 0) AS OPBAL, ISNULL(LEDGERS.Acc_drcr, '') AS DRCR, ISNULL(AREAMASTER.area_name, '') AS AREA, '' AS DISTRICT, ISNULL(CITYMASTER.city_name, '') AS CITY, ISNULL(STATEMASTER.state_name, '') AS STATE, ISNULL(COUNTRYMASTER.country_name, '') AS COUNTRY, ISNULL(LEDGERS.Acc_resino, '') AS RESINO, ISNULL(LEDGERS.Acc_altno, '') AS ALTNO, ISNULL(LEDGERS.Acc_phone, '') AS PHONENO, ISNULL(LEDGERS.Acc_mobile, '') AS MOBILE, ISNULL(LEDGERS.Acc_fax, '') AS FAX, ISNULL(LEDGERS.Acc_website, '') AS WEBSITE, ISNULL(LEDGERS.Acc_email, '') AS EMAIL, ISNULL(LEDGERS.Acc_panno, '') AS PANNO,ISNULL(LEDGERS.Acc_add1, '') AS [ADD1],ISNULL(LEDGERS.Acc_add2, '') AS [ADD2], ISNULL(LEDGERS.Acc_add, '') AS [ADD], ISNULL(LEDGERS.Acc_tinno, '') AS TANNO, ISNULL(LEDGERS.Acc_cstno, '') AS CSTNO, ISNULL(LEDGERS.Acc_vatno, '') AS VATNO, ISNULL(LEDGERS.ACC_GSTIN, '') AS GSTIN, ISNULL(AGENTLEDGERS.Acc_cmpname, '') AS AGENTNAME, '' AS TERM, ISNULL(PARTYBANKMASTER.PARTYBANK_name, '') AS PARTYBANK, ISNULL(LEDGERS.ACC_ACCOUNTTYPE, '') AS ACCOUNTTYPE, ISNULL(LEDGERS.ACC_ACCOUNTNO, '') AS ACCOUNTNO, ISNULL(LEDGERS.ACC_IFSC, '') AS IFSCCODE, ISNULL(LEDGERS.ACC_BRANCH, '') AS BRANCH, ISNULL(BANKCITY.city_name, '') AS BANKCITY, ISNULL(LEDGERS.Acc_remarks, '') AS REMARKS, ISNULL(LEDGERS.ACC_INTPER, 0) AS INTPER, ISNULL(LEDGERS.Acc_crdays, 0) AS CRDAYS, ISNULL(LEDGERS.Acc_crlimit, 0) AS CRLIMIT, ISNULL(ACCOUNTSMASTER_TDS.ACC_TDSPER, 0) AS TDSPER, ISNULL(TRANSLEDGERS.Acc_cmpname, '') AS TRANSPORT, ISNULL(LEDGERS.Acc_name, '') AS CONTACT, ISNULL(LEDGERS.Acc_zipcode, '') AS ZIPCODE, ISNULL(LEDGERS.ACC_DELIVERYPINCODE, '') AS DELIVERYPINCODE, ISNULL(CAST(LEDGERS.Acc_shippingadd AS VARCHAR(500)), '') AS SHIPPINGADD, ISNULL(LEDGERS.ACC_KMS, 0) AS KMS, ISNULL(LEDGERS.ACC_CDPER, 0) AS CDPER, ISNULL(LEDGERS.ACC_DISC, 0) AS DISC, ISNULL(LEDGERS.ACC_AGENTCOMM, 0) AS BROKERAGE, ISNULL(LEDGERS.Acc_mobile, '') AS WHATSAPPNO, ISNULL(LEDGERS.ACC_RD, 0) AS RATEDIFF, ISNULL(GROUPOFCOMPANIESMASTER.GOC_NAME, '') AS GROUPOFCOMPANIES, ISNULL(LEDGERS.ACC_MSMENO, '') AS MSMENO, ISNULL(LEDGERS.Acc_range, '') AS TALLYLEDGER, ISNULL(LEDGERS.ACC_BLOCKED, 0) AS BLOCKED, USERMASTER.User_Name AS USERNAME, '' AS EXMILLDISC, ISNULL(ACCOUNTSMASTER_TDS.ACC_SECTION, '') AS TDSSECTION, ISNULL(LEDGERS.ACC_TDSCOMPANY, '') AS TDSCOMPANY, '' AS COMMISSION ", "", "    LEDGERS INNER JOIN GROUPMASTER ON LEDGERS.Acc_groupid = GROUPMASTER.group_id LEFT OUTER JOIN CITYMASTER AS BANKCITY ON LEDGERS.ACC_BANKCITYID = BANKCITY.city_id LEFT OUTER JOIN GROUPOFCOMPANIESMASTER ON LEDGERS.ACC_GOCID = GROUPOFCOMPANIESMASTER.GOC_ID LEFT OUTER JOIN PARTYBANKMASTER ON LEDGERS.ACC_BANKID = PARTYBANKMASTER.PARTYBANK_id LEFT OUTER JOIN CITYMASTER AS CITYMASTER ON LEDGERS.Acc_cityid = CITYMASTER.city_id LEFT OUTER JOIN AREAMASTER ON LEDGERS.Acc_areaid = AREAMASTER.area_id LEFT OUTER JOIN STATEMASTER ON LEDGERS.Acc_stateid = STATEMASTER.state_id LEFT OUTER JOIN COUNTRYMASTER ON LEDGERS.Acc_countryid = COUNTRYMASTER.country_id LEFT OUTER JOIN LEDGERS AS AGENTLEDGERS ON LEDGERS.ACC_AGENTID = AGENTLEDGERS.Acc_id LEFT OUTER JOIN LEDGERS AS TRANSLEDGERS ON LEDGERS.ACC_TRANSID = TRANSLEDGERS.Acc_id LEFT OUTER JOIN ACCOUNTSMASTER_TDS ON LEDGERS.Acc_id = ACCOUNTSMASTER_TDS.ACC_ID LEFT OUTER JOIN USERMASTER ON LEDGERS.Acc_userid = USERMASTER.User_id", WHERECLAUSE & " AND LEDGERS.ACC_YEARID = " & YearId & " ORDER BY LEDGERS.ACC_CMPNAME")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles CMDPRINT.Click
        Try
            Dim PATH As String = "" = ""
            If FileIO.FileSystem.FileExists(PATH) = True Then FileIO.FileSystem.DeleteFile(PATH)
            PATH = Application.StartupPath & "\Ledger Details.XLS"
    ...
    Private Sub LedgerDetailsReport_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Try
            If ClientName = "SANGHVI" Then GMSMENO.Caption = "Tally Ledger Name"
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
